...
export const AllRecordsDoc = gql`
  ...
  records {
    ...
    `;
export const InsertRecordDoc = gql`
...
export const InsertRecord = (
            options: Omit<
              MutationOptions<any, InsertRecordMutationVariables>, 
              "mutation"
            >
          ) => {
            const m = client.mutate<InsertRecordMutation, InsertRecordMutationVariables>({
              mutation: InsertRecordDoc,
              ...options,
            });
            return m;
          }