...
export type AllRecordsQuery = { __typename?: 'query_root', records: Array<{ __typename?: 'records', active: boolean, boundary: string, label: string, periodicity: number, tags?: string | null, url: string }> };
...
export type MyMutationMutation = { __typename?: 'mutation_root', insert_records_one?: { __typename?: 'records', id: number } | null };


export const AllRecordsDoc = gql`
    query AllRecords {
  records {
    active
    boundary
...
export const MyMutationDoc = gql`
    mutation MyMutation($tags: String = "", $url: String = "", $periodicity: Int = 10, $label: String = "", $boundary: String = "", $active: Boolean = false) {
  insert_records_one(
...
export const AllRecords = (
            options: Omit<
              WatchQueryOptions<AllRecordsQueryVariables>, 
              "query"
            >
          ): Readable<
            ApolloQueryResult<AllRecordsQuery> & {
              query: ObservableQuery<
                AllRecordsQuery,
                AllRecordsQueryVariables
              >;
            }
          > => {
